...
- It acts also as a form of documentation of the code per se. For example you should know what happened to the code and the structure of the project by looking at commit messages.
